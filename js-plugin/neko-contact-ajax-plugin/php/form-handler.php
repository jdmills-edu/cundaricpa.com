...
$to = "cundaricpa@gmail.com";
$subject = "CundariCPA.com Contact Form";
...
if ($errors) {
    ...
    // Send the email
    $headers  = "From: contact@cundaricpa.com" . PHP_EOL;
    ...
    if(mail($to, $subject, $mailBody, $headers)){
        echo '<div class="alert alert-success">Success! Cundari &amp; Cundari CPAs will contact you within two business days.</div>';
    }
}
